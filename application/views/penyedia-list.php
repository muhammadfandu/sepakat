  ...
  <div class="container filter-box">
    ...
    <div class="row">
      <div class="col-md-4 text-left" style="line-height:2;">
        <h3 style="color:grey;">Tipe Penyedia</h3>
        <div class="checkbox">
          <label><input type="checkbox" />Penyedia Besar</label><br>
          <label><input type="checkbox" />Penyedia Sedang</label><br>
          <label><input type="checkbox" />Penyedia Kecil</label><br>
          <label><input type="checkbox" />Home Industri</label><br>
        </div>
      </div>
      <div class="col-md-4 text-left" style="line-height:2;">
        <h3 style="color:grey;">Kemampuan Penyedia</h3>
        <div class="checkbox">
          <label><input type="checkbox" /> > 2 Ton / Bulan</label><br>
          <label><input type="checkbox" />1 - 2 Ton / Bulan</label><br>
          <label><input type="checkbox" />0.5 - 1 Ton / Bulan</label><br>
          <label><input type="checkbox" />< 0.5 Ton / Bulan</label><br>
        </div>
      </div>
      <div class="col-md-4 text-left" style="line-height:2;">
...
<div class="container-fluid section1" style="padding-top:80px;">
  <div class="container">
    ...
    <div class="col-xs-12 company-item">
      <a href="<?php echo base_url();?>penyedia/detail">

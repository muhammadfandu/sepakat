<div class="sub-banner" >
  ...
  <div class="container filter-box" style="text-align:left;font-size:120%;line-height:2;">
    <div class="row company-itemhead">
      ...
      <div class="col-md-9">
        <h2 style="margin-top:0;font-weight: 200;">Hutan Pinus Maju Jaya</h2>
        <span style="color:#b0b0b0;">Kehutanan</span>  <span class="label-primary">Menyediakan : Kayu</span>
      </div>
    ...
    <div class="row company-itemfoot" style="background-color:white;font-size:80%;">
      <div class="text-left">
        <div class="col-md-4">
          <span><i class="fa fa-fw fa-map-marker"></i> Malang, Jawa Timur</span><br>
        </div>
        <div class="col-md-4">
          <span><i class="fa fa-fw fa-cubes"></i> 1-2 Ton / bulan</span>
        </div>
        <div class="col-md-4">
          <span><i class="fa fa-fw fa-exchange"></i> lorem ipsum</span>
        </div>
        <div class="col-md-4">
          <span><i class="fa fa-fw fa-envelope"></i> pinusjaya@mail.com</span><br>
        </div>
        <div class="col-md-4">
